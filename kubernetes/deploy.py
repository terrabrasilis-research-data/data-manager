...
deployment_config = load_yaml("research-data-repository/kubernetes/postgis/postgis-deployment.yaml")
service_config = load_yaml("research-data-repository/kubernetes/postgis/postgis-service.yaml")
